document.addEventListener("DOMContentLoaded", () => {
  ...
  const adjustButtonPositionsOnScroll = () => {
    const initialOffsetVertical = 70.5; // Adjust this value based on your button's top position in vh for vertical layout
    const additionalOffsetVertical = 80.3; // Adjusted position for cloned button for vertical layout
